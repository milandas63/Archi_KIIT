...
SELECT c.slno,c.name,c.gender,c.dob,c.mobile_no,l.location_desc,r.relation_desc FROM contact AS c LEFT JOIN location AS l ON c.location_id=l.location_id LEFT JOIN relation AS r ON c.relation_id=r.relation_id
